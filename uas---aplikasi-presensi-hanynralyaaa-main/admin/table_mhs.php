                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><a href='update_mhs.php?nim=<?= $row['nim'] ?>'><i class="bi bi-pencil-fill"></i></a> |
                                                        <a onClick="return confirm ('Are you sure?')" href='delete_mhs.php?nim=<?= $row['nim'] ?>'><i class="bi bi-trash-fill"></i></a>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
